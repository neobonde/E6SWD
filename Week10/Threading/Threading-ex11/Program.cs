...
namespace Threading_ex11
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Thread t1 = new Thread(() => Count(@"../../Cards/cards.txt"));
            Thread t2 = new Thread(() => Count(@"../../Cards/cards2.txt"));
            Thread t3 = new Thread(() => Count(@"../../Cards/cards3.txt"));
